...
/**
 * Brazil airdrop mint — Portuguese localized claim flow.
 * Extracted from br-mint-content.tsx. Owns the full ready/enter-pin/minting/
 * success/error state machine for one user's participation. Sibling of
 * WalletSetup; renders WalletSetup inline when the user is signed in but
