...
import { Ticket, ImagePlus, Loader2, X } from "lucide-react";
  ...
  if (!hasWallet) {
    return (
      <LaunchpadSignedOutState
        ...
        title="Secure your account to create tickets"
    ...
    <>
      ...
      >
        <p className="text-sm text-muted-foreground text-center">
          ...
          live — create tickets from its collection page.
        </p>
        {imagePreview && (
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full pt-1">
          ...
          {deployedAddress && (
            <Button asChild className="flex-1 bg-teal-600 hover:bg-teal-700 text-white">
              <Link href={collectionHref("STARKNET", deployedAddress)}>Create tickets</Link>
            </Button>
          )}
        </div>
      </WalletTransactionDialog>
      ...
      <ClaimRouteShell
        ...
        subtitle="One collection — create tickets and mint them to your audience."
        aside={
          <>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <FormField control={form.control} name="name" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="My Tickets" {...field} /></FormControl>
                <FormDescription>Shown in wallets, explorers, and on every ticket.</FormDescription>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="description" render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="Describe your tickets — what do they admit or unlock?" rows={3} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
