    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-[calc(100%-6px)] sm:max-w-md p-0 overflow-hidden gap-0 rounded-2xl">
        ...
        <TransactionDialogStates
          ...
          successTitle="Token archived"
          successBody="The legal record is preserved on-chain forever."
          errorTitle="Archive failed"
          errorDescription="The transaction was submitted, but the token could not be archived."
          errorAssetName={tokenName ?? "Token"}
          onRetry={() => reset()}
          onDone={() => {
            onOpenChange(false);
            onArchived?.();
